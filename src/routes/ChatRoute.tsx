  ...
  return (
    <div className="pointer-events-none fixed right-0 bottom-0 left-0 px-4 pb-4 md:left-[calc(var(--sidebar-width,0px)+0px)]">
      <div className="pointer-events-auto mx-auto max-w-3xl">
        <div className="rounded-2xl bg-[var(--chat-input-bg)] shadow-[0_14px_38px_rgba(0,0,0,0.38)]">
          <textarea
            value={inputValue}
            ...
            rows={1}
            className="max-h-[200px] min-h-[60px] w-full resize-none bg-transparent px-4 pt-3 pb-2 text-[15px] text-[var(--chat-text-primary)] outline-none placeholder:text-[var(--chat-text-muted)]"
        ...
        <p
          className="mt-2 text-center text-xs text-[var(--chat-text-subtle)]"
          style={{ fontFamily: '"DM Sans", sans-serif' }}
        >
